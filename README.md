...
Tailwind 4 · Zustand · Framer Motion · Vitest · Playwright (캡처) · Firebase Hosting · GitHub Actions
...
src/
  ...
  components/
    ...
    ui/
  lib/
    game/               # 룰·덱·NPC AI·타입 (순수 로직, 단위 테스트 대상)
    store/gameStore.ts  # Zustand 스토어 (게임 흐름 + NPC 턴 스케줄)
